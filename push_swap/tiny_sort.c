...
/*   Updated: 2024/09/04 15:38:59 by marcsilv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void tiny_sort(t_stack *stack, char stack_name)
{
        ...
        highest_number_position = highest_number_index(stack);
        if (stack_name == 'a')
        {
                if (stack->collection[highest_number_position] == stack->collection[2])
                        rotate(stack, "ra");
                else if (stack->collection[highest_number_position] == stack->collection[1])
        ...
        {
                if (stack->collection[highest_number_position] == stack->collection[0])
