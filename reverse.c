...
/*   Updated: 2024/07/31 15:40:27 by marcsilv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	reverse_reverse(t_stack *stack, char *op)
{
	...
	else
	{
		...
		ft_memmove(&stack->collection[0], &stack->collection[1], (stack->capacity - 1) * sizeof(int));
		stack->collection[stack->top] = temp;
	}
	if (*op)
		ft_printf("%s\n", op);
}
void	reverse_reverse_both(t_stack *stack, t_stack *stack)
{
